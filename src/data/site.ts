export const site = {
  ...
  socials: [
    { label: 'GitHub', href: 'https://github.com/Gall-ardo' },
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/halil-arda-ozongun/' },
{ label: 'Email', href: 'mailto:halilardaozongun@gmail.com' },
  ],
};
